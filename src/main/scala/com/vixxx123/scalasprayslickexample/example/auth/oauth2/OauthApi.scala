 ...
 */
package com.vixxx123.scalasprayslickexample.example.auth.oauth2
...
import com.vixxx123.scalasprayslickexample.example.auth.oauth2.session._
import com.vixxx123.scalasprayslickexample.rest.{BaseResource, BaseResourceBuilder}
